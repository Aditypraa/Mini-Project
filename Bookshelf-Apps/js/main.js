...
btnSubmit.addEventListener("click", function () {
  if (btnSubmit.value == "") {
    ...
    if (year.value == "") {
      ...
      checkYear = !isNaN(year.value) && Number(year.value);
    }
    ...
    if (book.isCompleted == false) {
      let el = `
            <article class="book_item">
                ...
                <div class="action">
                    <button class="green" onclick="readedBook('${book.id}')">Completed Reading</button>
                    <button class="yellow" onclick="editBook('${book.id}')">Edit Buku</button>
                    <button class="red" onclick="deleteBook('${book.id}')">Delete buku</button>
                </div>
            </article>
            `;
