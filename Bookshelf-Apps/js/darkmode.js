...
function toDark() {
  ...
  document
    .querySelector("#bookShelfUncompleted")
  ...
  document
    .querySelector("#completeBookshelfList")
    .classList.toggle("color-dark");
  ...
  document
    .querySelector("#inputBookTitle")
    .labels[0].classList.toggle("color-dark");
  document
    .querySelector("#inputBookAuthor")
    .labels[0].classList.toggle("color-dark");
  document
    .querySelector("#inputBookYear")
    .labels[0].classList.toggle("color-dark");
  document
    .querySelector("#inputBookIsComplete")
    .labels[0].classList.toggle("color-dark");
}
